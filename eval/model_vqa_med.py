...
def eval_model(args):
    ...
    for i, line in enumerate(tqdm(questions)):
        ...
        qs = question['value']
        # if gt_ans['value'] .lower() == 'yes' or gt_ans['value'] .lower() == 'no':
        #     qs += 'This is a judgment question. Please start with yes or no.'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--conv-mode", type=str, default="default", choices=["default", "simple", "simple_legacy", "multimodal", "llava_v1"])  # 添加 conv-mode 作为参数
